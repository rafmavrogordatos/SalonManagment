...
$stmt = $db->prepare('SELECT resetToken, resetComplete FROM accountants WHERE resetToken = :token');
...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = $db->prepare("UPDATE accountants SET password = :hashedpassword, resetComplete = 'Yes'  WHERE resetToken = :token");
			$stmt->execute(array(
