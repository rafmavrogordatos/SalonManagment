...
$req2 = mysql_query('select pm.timestamp, pm.message, members.id as userid, members.username from pm, members where pm.id="'.$id.'" and members.id=pm.user1 order by pm.id2');
